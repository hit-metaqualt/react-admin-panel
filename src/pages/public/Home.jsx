...
// const techLogos = [
//   { src: "https://logos-world.net/wp-content/uploads/2021/02/AWS-Logo.png", alt: "AWS" },
//   { src: "https://logos-world.net/wp-content/uploads/2021/03/Microsoft-Azure-Logo.png", alt: "Azure" },
//   { src: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Twilio-logo-red.svg/1280px-Twilio-logo-red.svg.png", alt: "Twilio" },
//   { src: "https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg", alt: "WhatsApp API" },
// ];
      ...
      <div className="secon-header-01 animate__animated animate__backInDown" data-wow-delay="0.1s">
        <div className="wrapper">
          <div className="second-header-01-navbar-menu">
            ...
            <h1 className="company-name">DocuSwift</h1>
      ...
      <section className="hero-banner ">
        ...
        <div className="wrapper">
          <div className="hero-top-section animate__animated animate__swing" data-wow-delay="0.3s">
            <h1 className="hero-title">Welcome to DocuSwift</h1>
